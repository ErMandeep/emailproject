<div class="p-6 " >
    ...
    <div class="flex flex-col">
        <div class="-may-2  overflow-x-auto sm:-mx-6 lg:-mx-8 ">
...
<br>
    ...
    <x-jet-dialog-modal wire:model="modalFormVisible">
        ...
        <x-slot name="footer">
            ...
            @if($modelId)
            <x-jet-button class="m-2" wire:click="update" wire:loading.attr="disabled">
                {{ __('Update') }}
            </x-jet-button>
            @else
            <x-jet-button class="m-2" wire:click="create" wire:loading.attr="disabled">
                {{ __('Save') }}
            </x-jet-button>
            @endif
        </x-slot>
